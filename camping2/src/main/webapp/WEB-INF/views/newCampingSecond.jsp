  ...
  <h2>캠핑장 상세등록</h2>
	  <form method="POST" action="${cpath }/newCampingSecond">
	    ...
	    <!-- camping_introduce -->
	     ...
	     <div class="mb-3">
	      <label>운영 기간:</label>
	     	<input type="checkbox" name="operPdCl" value="봄" required>
	     		<label>봄</label>
	    ...
	    <div class="mb-3">
	      <label>바닥재:</label>
		    ...
		    <input type="submit" class="btn btn-primary" value="다음" id="btn">
	  </form>
</div>
<script>
...
<script>
	...
	function handler(event) {
		...
		const url = '${cpath }/newCampingSecond?mapX=${mapX}&mapY=${mapY}';
