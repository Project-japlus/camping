...
public class CampingDTO {
	...
	private int swrmCo;
	private String glamplnnerFclty;
	private String caravlnnerFclty;

	// camping_introduce
	private String caravAcmpnyAt;
	private String trlerAcmpnyAt;
	private String operPdCl;
	private String perDeCl;
	...
	public int getCamping_viewCount() {
		return camping_viewCount;
	}
	public void setCamping_viewCount(int camping_viewCount) {
	...
	public String getGlamplnnerFclty() {
		return glamplnnerFclty;
	}
	public void setGlamplnnerFclty(String glamplnnerFclty) {
		this.glamplnnerFclty = glamplnnerFclty;
	}
	public String getCaravlnnerFclty() {
		return caravlnnerFclty;
	}
	public void setCaravlnnerFclty(String caravlnnerFclty) {
		this.caravlnnerFclty = caravlnnerFclty;
	}
	...
	public String getPerDeCl() {
		return perDeCl;
	}
	public void setPerDeCl(String perDeCl) {
		this.perDeCl = perDeCl;
	}
