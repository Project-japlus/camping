...
<%@ include file="../header.jsp" %>
	...
	<div class="progress w-50 m-auto mt-2">
  ...
  <div class="row d-flex border border-1 rounded-2 w-50 m-auto mt-4 p-2" style="height: 60px;">
   ...
   <div class="row d-flex border border-1 rounded-2 w-50 m-auto mt-3 p-3">
        <div class="container">
            ...
            <h5 class="ms-2">결제완료 : <span class="fw-bold text-warning"><fmt:formatNumber pattern="#,##0">${price}</fmt:formatNumber>원</span></h5>                   
        </div>      
   </div>
   ...
   <div class="d-grid">
    	 <button id="home" class="btn btn-primary btn-block w-50 m-auto mt-3">메인으로</button>
   </div> 
