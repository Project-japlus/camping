...
<div class="main">
	...
	<form>
		<div class=" w-75 m-auto rounded-3" style="background-color: #eee;">
			<br>
			<!-- 히든 -->
			<input type="hidden" name="mapX" id="mapX"> <input
				type="hidden" name="mapY" id="mapY">
			...
			<div class="d-flex w-75 m-auto">
				...
				<select class="form-select w-25 m-auto ms-2" name="firstSelect"
...
<script>
	...
	function changeSecondOptions() {
		...
		if (selectedValue == '서울시') {
			...
			var busanOptions = [ "가평군", "고양시", "과천시", "광명시", "광주시", "구리시",
