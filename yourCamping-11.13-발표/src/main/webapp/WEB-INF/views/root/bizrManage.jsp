...
<div class="container mt-3">
	<h4 class="fw-bold mb-4">사업주관리</h4>
	<div class="alert alert-warning">
		<strong class="fst-italic">최근 가입된 사업주목록</strong>
	</div>
		...
		<tbody>
			...
			<c:forEach var="dto" items="${bizrlist }">
				<tr>
					...
					<td>${dto.bizrno }</td>
					<td>
						<button id="deleteUserByRootBtn_${dto.user_idx}"
							class="btn btn-danger fw-bold" style="opacity: .7;">탈퇴</button>
					</td>
				</tr>
