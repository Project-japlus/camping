...
<div class="main">
	...
	<div style="width: 70%; margin: auto;">
		...
		<div class="d-flex">
			<button id="prev"  class="btn btn-outline-light text-dark h-25" style="margin-top: 300px;">◀</button>
			<div id="imgBox">
			...
			<button id="next" class="btn btn-outline-light text-dark h-25" style="margin-top: 300px;">▶</button>
		</div>
