...
//	//등록내역 지우기 
//	@GetMapping("/newCampingDelete/{camping_idx}")
//	public String newCampingDelete(@PathVariable("camping_idx") int camping_idx) {
//		int row = rootService.newCampingDelete(camping_idx);
//		System.out.println(row != 0 ? "등록삭제완료" : "실패");
//		return "redirect:/root/newCampingDelete/"+camping_idx;
//	}
