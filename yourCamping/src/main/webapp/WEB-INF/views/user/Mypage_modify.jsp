...
<div class="main">
    <div class="container mt-3">
        ...
        <hr>
        <table id="modify_table" class="table table-bordered w-50 m-auto p-2">
            <tr>
                <td>이름</td>
                <td>
                	${login.username }
            ...
            <tr>
                ...
                <td>
                    <div>
                        ${login.phone }
                        <button class="btn btn-primary ms-2">휴대폰 번호 변경</button>
                    </div>
                </td>
            </tr>
            <tr>
                <td class="w-25">비밀번호 <br>변경</td>
                <td>
                    <div>
    ...
    <!-- footer -->
    <div class="container mt-3 d-flex justify-content-center" style="margin-left: 370px;">
