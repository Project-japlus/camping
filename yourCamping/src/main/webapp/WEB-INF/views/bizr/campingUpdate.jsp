...
<hr>
    <div class=" w-75 m-auto rounded-3" style="background-color: #eee;">
       	<div class="mt-4 mb-5 text-white rounded w-75 m-auto" style="padding-top:60px;">
       		<h1 class="fw-bold  mb-4 fst-italic text-dark">캠핑장 수정</h1>
       		<div class="fw-bold text-dark">캠핑장 상세정보를 업데이트할 수 있습니다.  </div>
 		</div>
         <form method="POST" enctype="multipart/form-data" id="form-update">
           ...
           <!-- 이름 -->
           <span class="input-group-text fw-bold">캠핑장명</span>
           <input type="text" class="form-control" name="facltnm" required value="${dto.facltnm }">
           </div>
           <!--툴팁-->
           <div class="m-auto w-75">
           <label for="comment" class="fw-bold mb-3">특징</label>
           <textarea class="form-control mb-3" rows="5" id="comment" name="featurenm">${dto.featurenm }</textarea>
   
           <label for="comment" class="fw-bold mb-3">툴팁</label>
           <textarea class="form-control mb-3" rows="5" id="comment" name="tooltip">${dto.tooltip }</textarea>
           </div>
           ...
           <div class="d-flex w-75 m-auto mb-3">     
               <div class="form-check">
                   <input class="form-check-input" type="checkbox" id="check1" name="induty" value="일반 야영장" checked>
                   <label class="form-check-label">일반 야영장</label>
               </div>
               <div class="form-check ms-4">
                   <input class="form-check-input" type="checkbox" id="check1" name="induty" value="자동차 야영장" >
                   <label class="form-check-label">자동차 야영장</label>
               </div>
               <div class="form-check ms-4">
                   <input class="form-check-input" type="checkbox" id="check1" name="induty" value="글램핑" >
                   <label class="form-check-label">글램핑</label>
               </div>
               <div class="form-check ms-4">
                   <input class="form-check-input" type="checkbox" id="check1" name="induty" value="카라반" >
                   <label class="form-check-label">카라반</label>
               </div>
           </div>
   
           <div class="input-group mb-3 w-75 m-auto">
               <span class="input-group-text fw-bold">연락처</span>
               <input type="text" class="form-control" name="tel" placeholder="phone" value="${dto.tel }">
           </div>
   
           <div class="input-group mb-3 w-75 m-auto">
               <span class="input-group-text fw-bold">https:</span>
               <input type="text" class="form-control" name="homepage" placeholder="URL" value="${dto.homepage }">
           </div>
           
           <div class="fw-bold w-75 m-auto">입지</div>
           <div class="d-flex w-75 m-auto mb-3">     
               <div class="form-check">
                   <input class="form-check-input " type="checkbox" id="check1" name="lctcl" value="산" checked>
                   <label class="form-check-label">산</label>
               </div>
               <div class="form-check ms-4">
                   <input class="form-check-input " type="checkbox" id="check1" name="lctcl" value="숲" >
                   <label class="form-check-label ">숲 </label>
               </div>
               <div class="form-check ms-4">
                   <input class="form-check-input " type="checkbox" id="check1" name="lctcl" value="해변" >
                   <label class="form-check-label">해변 </label>
               </div>
               <div class="form-check ms-4">
                   <input class="form-check-input " type="checkbox" id="check1" name="lctcl" value="계곡" >
                   <label class="form-check-label ">계곡 </label>
               </div>
               <div class="form-check ms-4">
                   <input class="form-check-input" type="checkbox" id="check1" name="lctcl" value="강" >
                   <label class="form-check-label ">강  </label>
               </div>
               <div class="form-check ms-4">
                   <input class="form-check-input " type="checkbox" id="check1" name="lctcl" value="도심" >
                   <label class="form-check-label ">도심  </label>
               </div>
               <div class="form-check ms-4">
                   <input class="form-check-input " type="checkbox" id="check1" name="lctcl" value="섬" >
                   <label class="form-check-label ">섬 </label>
               </div>
           </div>
           ...
           <div class="d-flex w-75 m-auto">
               ...
               <select id="firstSelect"  class="form-select w-25 m-auto ms-2" name="firstSelect"  onchange="changeSecondOptions()">
               ...
               <select class="form-select w-25 m-auto ms-2" id="secondSelect" name="secondSelect"></select>
           ...
           <div class="d-flex w-75 m-auto mt-3">
               ...
               <input type="file" name="upload1" class="btn btn-white ms-4" value="Input Button">
           </div>
           <div class="d-flex w-75 m-auto mt-3">
               <div class="fw-bold">상세사진</div>
               <input type="file" name="upload2" multiple="multiple" required id="upload2Update" class="btn btn-white ms-4" value="Input Button">
           </div>
           <!--주변이용 가능한 시설 -->
   
           <div class="form-floating mb-3 mt-3 m-auto w-75">
               <input type="text" class="form-control"  name="posblFcltyCl" value="${dto.posblFcltyCl }">
               <label class="fw-bold">주변이용가능시설</label>
           </div>
           <div class="form-floating mb-3 mt-3 m-auto w-75">
               <input type="text" class="form-control"  name="posblFcltyEtc" value="${dto.posblFcltyEtc }">
               <label class="fw-bold">시설 기타</label>
           </div>
           <div class="form-floating mb-3 mt-3 m-auto w-75">
               <input type="text" class="form-control"  name="exprnprogrm" value="${dto.exprnprogrm }">
               <label class="fw-bold">체험 프로그램</label>
           </div>
           <div class="form-floating mb-3 mt-3 m-auto w-75">
               <input type="text" class="form-control"  name="direction" value="${dto.direction }">
               <label class="fw-bold">오시는 길</label>
           </div>
           <br>
           <br>
