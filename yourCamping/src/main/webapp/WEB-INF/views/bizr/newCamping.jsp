...
<body>
    ...
    <div class="mt-4 p-5 bg-warning mb-5 text-white rounded w-75 m-auto">
        <h1 class="fw-bold  mb-4 fst-italic text-dark">지금 개장한 멋진 캠핑장을 소개해보세요!</h1>
        <div class="fw-bold text-dark">최근에 개장한 캠핑장을 저희 플랫폼에 등록하고 특별한 제휴 혜택을 누려보세요.</div>
        <div class="fw-bold text-dark">캠핑을 사랑하는 많은 여행객들이 여러분의 캠핑장을 찾고 있습니다.</div>    
    </div>
    <form>
    <div class=" w-75 m-auto rounded-3" style="background-color: #eee;">
        ...
        <!-- 이름 -->
            ...
            <input type="text" class="form-control" name="facltnm">
        </div>
        <!--툴팁-->
        <div class="m-auto w-75">
            <label for="comment" class="fw-bold mb-3">특징</label>
            <textarea class="form-control mb-3" rows="5" id="comment" name="featurenm"></textarea>

            <label for="comment" class="fw-bold mb-3">툴팁</label>
            <textarea class="form-control mb-3" rows="5" id="comment" name="tooltip"></textarea>
        </div>
        ...
        <div class="input-group mb-3 w-75 m-auto">
            ...
            <input type="text" class="form-control" name="homepage" placeholder="URL">
        </div>
        ...
        <div class="d-flex w-75 m-auto">
            ...
            <select class="form-select w-25 m-auto ms-2" name="firstSelect"  onchange="changeSecondOptions()">
        ...
        <div class="d-flex w-75 m-auto mt-3">
            ...
            <input type="file" name="upload2" multiple="multiple" required id="upload2"    class="btn btn-white ms-4" value="Input Button">
        </div>
        <!--주변이용 가능한 시설 -->
