    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-inline m-auto" method="POST" action="${cpath }/user/login">
                    <div class="form-group w-75 p-1 m-auto">
                        <label for="email opacity-100">아이디</label> <input type="text" class="form-control opacity-100"
                            placeholder="아이디" name="userid">
                    </div>
                    <div class="form-group w-75 p-1 m-auto">
                        <label for="password">Password</label> <input type="password"
                            class="form-control opacity-100 w-160" id="userpw" placeholder="Password" name="userpw">
                    </div>
                    <div class="checkbox opacity-100 m-auto ms-5 ps-2">
                        <div class="d-flex">
                            <label> <input class="ms-2" type="checkbox" name="remember">아이디저장
                            </label> <label><input class="ms-5" type="checkbox" name="remember">사업자 로그인</label>
                        </div>
                    </div>
                    <div class="ms-3 mt-4">
                ...
                <div class="ms-3">
                    <div class="d-flex justify-content-between">
                        <a data-bs-toggle="modal" href="#exampleModalToggle" role="button">
                            <button class="btn btn-primary p-2" style="width: 150px; margin-left: 48px">회원가입</button>
                            ...
                            <div class="d-flex flex-column w-100 m-auto">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    <input type="text" name="userid" placeholder="아이디" required autofocus
                                        autocomplete="off" id="user_id">
                                    <button type="button" class="btn btn-primary" id="user_checkDuplicate"
                                ...
                                <div class="mb-1 d-flex justify-content-between ">
                                    <p class="mb-1">
                                        <input type="password" name="userpw" placeholder="비밀번호" id="user_pw1" required>
                                    </p>
                                </div>
                                <div>
                                    <p class="mb-2 d-flex justify-content-between">
                                        <input type="password" name="userpwCheck" id="user_pw2" placeholder="비밀번호  확인"
                                            required>
                                        <button class="btn btn-primary" onclick="userpw_test()" style="width: 100px;">PW
                                            확인</button>
                                    </p>
                                </div>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <div class="d-flex justify-content-between mb-2 mt-3">
                                            <input type="text" name="authNumber_user" placeholder="인증번호 입력"> <input
                                                id="emailAuthBtn" class="btn btn-primary mt-1" type="button"
                                                value="본인인증" style="width: 100px;">
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="modal-body">
                    <div class="container">
                        <div class="d-flex flex-column w-100 m-auto">
                            <form method="POST" action="${cpath }/user/bizr_join" id="bizrJoinForm">
                                <div class="mb-1">아이디</div>
                                <div class="d-flex justify-content-between mb-2">
                                    <input type="text" name="userid" placeholder="아이디" required autofocus
                                        autocomplete="off" id="bizr_id">
                                    <button type="button" class="btn btn-primary" id="bizr_checkDuplicate"
                                        style="width: 100px;">중복 확인</button>
                                </div>
                                <div class="mb-1">비밀번호</div>
                                <div class="mb-1 d-flex justify-content-between">
                                    <p class="mb-1">
                                        <input type="password" name="userpw" placeholder="비밀번호" id="bizr_pw1" required>
                                    </p>
                                </div>
                                <div>
                                    <p class="mb-2 d-flex justify-content-between">
                                        <input type="password" name="userpwCheck" id="bizr_pw2" placeholder="비밀번호  확인"
                                            required>
                                        <button class="btn btn-primary" onclick="bizrpw_test()" style="width: 100px;">PW
                                            확인</button>
                                    </p>
                                </div>
                                <div class="mb-1">이름</div>
                                ...
                                <div>
                                    <div>
                                        ...
                                        <div class="d-flex justify-content-between mb-2 mt-3">
                                            <input type="text" name="authNumber_bizr" placeholder="인증번호 입력"> <input
                                                id="emailAuthBtn1" class="btn btn-primary mt-1" type="button"
                                                value="본인인증" style="width: 100px;">
                                        </div>
                                    </div>
                                </div>
